...
-- ship review 
------------------------*/
create table t_ship_review (ship_review_id int not null, ship_id int not null, review_date datetime, review_stars int, review_text text, primary key (ship_review_id), foreign key (ship_id) references t_ship (ship_id));
